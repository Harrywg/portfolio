...
function sandboxOn() {
  ...
  document
    .getElementById("sandbox-return-wrap")
    .classList.add("sandbox-return-active");
  document.documentElement.style.setProperty("cursor", "none");
  document
    .getElementById("physics-engine-wrap")
    .classList.remove("less-opacity");
  isSandbox = true;
}
function sandboxOff() {
  ...
  document
    .getElementById("sandbox-return-wrap")
    .classList.remove("sandbox-return-active");
...
function animateAboutTitle() {
  ...
  let content = ["Problem Solver", "Builder", "Communicator"];
...
document.getElementById("wakatime-info").addEventListener("mouseover", (e) => {
  ...
  let iconRect = document
    .getElementById("wakatime-info")
...
document.getElementById("wakatime-info").addEventListener("mouseleave", (e) => {
  document
    .querySelector(".wakatime-info-hover-el")
    .classList.remove("wakatime-info-hover-el-active");
});
