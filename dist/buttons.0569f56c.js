...
function scrollToSection(elTag) {
  var section = document.querySelector(elTag);
...
function projectInfo(id) {
  ...
  var titles = Array.from(document.getElementsByClassName('project_title'));
...
function projectInfoBack(id) {
  ...
  var project = document.querySelector('.project_image-active').parentElement;
