...
})({"hVtW6":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "56d581bc4d1db4ed";
"use strict";
...
},{}],"hXee5":[function(require,module,exports) {
// DISCLAIMER!!!!
...
function animateBall(ballEl, ballSpeed) {
    (0, _gsapDefault.default).set(ballEl, {
        xPercent: -50,
        yPercent: -50
    });
    ...
    const xSet = (0, _gsapDefault.default).quickSetter(ball, "x", "px");
    const ySet = (0, _gsapDefault.default).quickSetter(ball, "y", "px");
    window.addEventListener("mousemove", (e)=>{
        mouse.x = e.x;
        mouse.y = e.y;
    });
    (0, _gsapDefault.default).ticker.add(()=>{
        const dt = 1.0 - Math.pow(1.0 - speed, (0, _gsapDefault.default).ticker.deltaRatio());
...
function sandboxOn() {
    ...
    document.getElementById("physics-engine-wrap").classList.remove("less-opacity");
    isSandbox = true;
}
function sandboxOff() {
    ...
    document.getElementById("physics-engine-wrap").classList.add("less-opacity");
    isSandbox = false;
}
...
},{"gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./buttons.js":"4cqvf"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4cqvf":[function(require,module,exports) {
// DISCLAIMER!!!!
// - If you're looking through my portfolio to check out my code standard, please check out my most recent projects as this code is now very old and messy.
...
},{}]},["hVtW6","hXee5"], "hXee5", "parcelRequire94c2")

//# sourceMappingURL=index.4d1db4ed.js.map
