...
function alterDateFormat(date) {
  var withoutDay = date.substring(4, date.length);
  var withoutYear = withoutDay.substring(0, withoutDay.length - 4);
  return withoutYear;
}
$.ajax({
  type: 'GET',
  ...
  success: function success(response) {
    var daysArr = response.data;
    // console.log(daysArr)
    var startDate = alterDateFormat(daysArr[0].range.text);
    var endDate = alterDateFormat(daysArr[daysArr.length - 1].range.text);
    var totalHours = 0;
    var totalMinutes = 0;
    ...
    hours.textContent = "".concat(totalHours, " hours");
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/requests.js"], null)
//# sourceMappingURL=/requests.357535cb.js.map